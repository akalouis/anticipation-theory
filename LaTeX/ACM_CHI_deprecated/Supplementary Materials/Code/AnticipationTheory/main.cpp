...
{
	using namespace coin_toss_game;

	auto analysis = analyze<Game>();
...
int hpgame_program()
{
	...
	puts("\nNote: HpGame serves as a benchmark for 1v1 action-focused games.\n"
		...
		"  4. Play the demo locally: open Demo/hpgame.html\n"
	);
	return 0;
}
...
int hpgame_rage_optimized_program()
{
	...
	puts("\nNote: `hpgame_rage_optimized` uses parameters algorithmically optimized for Game Design Score (GDS).\n"
		...
		"  5. Play the demo locally: open Demo/hpgame_rage_optimized.html\n"
	);
...
int main()
{
	enum program_code
	{
		...
		hpgame,
		hpgame_interactive, // interactive demo
		hpgame_rage,
